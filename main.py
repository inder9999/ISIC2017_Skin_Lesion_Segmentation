...
from Models.networks.network import Comprehensive_Atten_Unet, Unet, CSARM_CNN
from Models.networks_other import ResnetGenerator
from Models.networks.FCN import FCN16s

from utils.dice_loss_CSARM import SoftDiceLoss_CSARM, get_soft_label_CSARM
...
Test_Model = {'Comp_Atten_Unet': Comprehensive_Atten_Unet, 'U_net':Unet, 'Res_Net' : ResnetGenerator, 'CSARM' : CSARM_CNN, 'FCN_16s' : FCN16s}
...
def main(args):
    ...
    model = Test_Model[args.id]( args.num_input, args.num_classes)
